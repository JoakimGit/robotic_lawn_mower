...
#define KP  0.5    // KP value of PID-regualtor controlling RPM offset
#define KI  4      // KI value of PID-regualtor controlling RPM offset
#define KD  0.00   // KD value of PID-regualtor controlling RPM offset
#define TF  0.000  // TF value of PID-regualtor controlling RPM offset
